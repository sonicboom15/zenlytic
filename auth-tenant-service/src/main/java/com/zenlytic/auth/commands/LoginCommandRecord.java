...
import com.zenlytic.common.exception.UnauthorizedException;
...
public class LoginCommandRecord {
    ...
    public record Command(LoginDto.Request request) implements com.zenlytic.common.cqrs.command.Command<LoginDto.Response> {}
