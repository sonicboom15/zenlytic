...
import com.example.auth.repository.AppVersionPolicyRepository;
...
public class CheckAppVersionQueryRecord {
    ...
    public record Query(String clientType, String clientVersion) implements com.example.common.cqrs.query.Query<AppVersionCheckDto> {}
