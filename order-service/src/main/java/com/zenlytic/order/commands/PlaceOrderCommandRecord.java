...
import com.zenlytic.order.entity.OrderItem;
import com.zenlytic.order.saga.OrderFulfillmentSagaOrchestrator;
...
public class PlaceOrderCommandRecord {
    ...
    public record Command(OrderDto.CreateRequest request) implements com.zenlytic.common.cqrs.command.Command<OrderDto.Response> {}
